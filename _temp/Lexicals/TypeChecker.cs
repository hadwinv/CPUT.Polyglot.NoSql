    ...
    public static class TypeChecker
    {
        public static ValueType CheckType(this Expr expr)
        {
            switch (expr)
            {
                ...
                case BinaryExpr binExpr:
                    ...
                    if (Operators11.BinaryComparisonOperators.Contains(binExpr.Operator) && !(binExpr.VectorMatching?.ReturnBool ?? false)
                    ...
                    if ((lhsType == ValueType.Scalar || rhsType == ValueType.Scalar) && Operators11.BinarySetOperators.Contains(binExpr.Operator))
                ...
                default:
                    return ValueType.None;//throw ExhaustiveMatch.Failed(expr);
            }
        }
        ...
        public class InvalidTypeException : Exception
        {
            ...
            private static string AsHumanReadable(ValueType vt) => vt switch
            {
                ...
                ValueType.None => "none",
                _ => "error"//throw ExhaustiveMatch.Failed(vt)
            };
        }
    }
}